...
//# sourceURL=${plugin.id}`;
        ...
        initPlugins() {
          return _async_to_generator(function* () {
            ...
            if (!settings.safeMode?.enabled) {
              yield allSettled(allIds.filter((pl) => plugins[pl].enabled).map((pl) => _async_to_generator(function* () {
      ...
      badges_default = defineCorePlugin({
        ...
        start() {
          ...
          after("default", useBadgesModule, ([user], result) => {
            var [badges, setBadges] = (0, import_react5.useState)([]);
  ...
  // src/core/plugins/notrack/lib/network.ts
  var network_default;
  ...
  // src/core/plugins/notrack/lib/console.ts
  var console_default;
  var init_console = __esm({
    "src/core/plugins/notrack/lib/console.ts"() {
      ...
      console_default = () => {
        var sentrified = {};
        try {
          Object.keys(console).forEach((x2) => {
            sentrified[x2] = console[x2];
            console[x2] = console[x2].__sentry_original__ ?? console[x2];
          });
        } catch (e) {
          logger.log("Failed to de-sentrify console functions!", e);
        }
        ;
        return () => Object.keys(console).forEach((x2) => console[x2] = sentrified[x2]);
      };
    }
  });

  // src/core/plugins/notrack/lib/utils.ts
  var noop;
  var init_utils2 = __esm({
    "src/core/plugins/notrack/lib/utils.ts"() {
      ...
      init_promiseAllSettled();
      init_patcher();
      noop = (prop, parent) => instead(prop, parent, () => {
      });
    }
  });

  // src/core/plugins/notrack/lib/miscellanous.ts
  var AnalyticsUtils, SuperPropUtils, VoiceStateUtils, CrashReportUtils, MetricsUtils, miscellanous_default;
  var init_miscellanous = __esm({
    "src/core/plugins/notrack/lib/miscellanous.ts"() {
      "use strict";
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      ...
      miscellanous_default = () => {
        var patches3 = [
          // Global analytics utilities
          ...[
            "handleTrack",
            "handleFingerprint"
          ].map((i) => noop(i, AnalyticsUtils.AnalyticsActionHandlers)),
  ...
  // src/core/plugins/notrack/lib/sentry.ts
  var Sentry, sentry_default;
  ...
  var init_notrack = __esm({
    "src/core/plugins/notrack/index.ts"() {
      ...
      notrack_default = defineCorePlugin({
        ...
        start() {
          network_default(), console_default(), miscellanous_default(), sentry_default();
        }
      });
    }
  });
  ...
  var init_plugins2 = __esm({
    "src/core/plugins/index.ts"() {
      ...
      getCorePlugins = () => ({
        ...
        "vendetta.notrack": (init_notrack(), __toCommonJS(notrack_exports))
      });
    }
  });
...
Type: ${asset.type}`,
  ...
  var import_react9, import_react_native31;
  ...
  var import_react10, import_react_native34, initVendettaObject;
  var init_api3 = __esm({
    "src/core/vendetta/api.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
                ...
                if (props.includes("ActionSheetTitleHeader")) {
                  ...
                  return {
                    ...
                    ActionSheetContentContainer: ({ children }) => {
                      ...
                      return /* @__PURE__ */ (0, import_react10.createElement)(import_react_native34.View, null, children);
                    }
                  };
                }
              }
