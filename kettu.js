...
(() => {
  ...
  // node_modules/.pnpm/es-toolkit@1.39.8/node_modules/es-toolkit/dist/function/debounce.mjs
  ...
  // node_modules/.pnpm/es-toolkit@1.39.8/node_modules/es-toolkit/dist/object/omit.mjs
  ...
  // node_modules/.pnpm/es-toolkit@1.39.8/node_modules/es-toolkit/dist/predicate/isNotNil.mjs
  ...
  // node_modules/.pnpm/es-toolkit@1.39.8/node_modules/es-toolkit/dist/index.mjs
  var init_dist = __esm({
    "node_modules/.pnpm/es-toolkit@1.39.8/node_modules/es-toolkit/dist/index.mjs"() {
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
...
//# sourceURL=${plugin.id}`;
  ...
  var init_url = __esm({
    "src/core/plugins/quickinstall/url.tsx"() {
      ...
      url_default = () => {
        ...
        patches2.push(instead("handleClick", handleClick, function(args, orig) {
          return _async_to_generator(function* () {
  ...
  var import_react6, import_react_native26, actionSheet2, openAlert3, AlertModal4, AlertActionButton4;
  ...
  function AssetDisplay({ asset }) {
    return /* @__PURE__ */ jsx(TableRow, {
      ...
      icon: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native28.Image, {
        source: asset.id,
        style: {
          width: 32,
          height: 32
...
Type: ${asset.type}`,
        extraContent: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native28.Image, {
          resizeMode: "contain",
          source: asset.id,
          style: {
            flex: 1,
  ...
  var import_react_native28, openAlert4, AlertModal5, AlertActionButton5, displayable, iconMap, copyToClipboard;
  ...
  function Developer() {
    ...
    return /* @__PURE__ */ jsx(ErrorBoundary, {
      children: /* @__PURE__ */ jsx(import_react_native31.ScrollView, {
        style: {
          flex: 1
        },
        contentContainerStyle: {
                ...
                isReactDevToolsPreloaded() && /* @__PURE__ */ jsx(Fragment, {
                  children: /* @__PURE__ */ jsx(TableRow, {
                    ...
                    onPress: () => globalThis[getReactDevToolsProp() || "__vendetta_rdc"]?.connectToDevTools({
                      ...
                      resolveRNStyle: import_react_native31.StyleSheet.flatten
                    })
                  })
                })
              ]
                      ...
                      actions: /* @__PURE__ */ jsxs(Stack, {
                        children: [
                          /* @__PURE__ */ jsx(AlertActionButton6, {
                            text: Strings.RELOAD,
                            variant: "destructive",
                            onPress: () => import_react_native30.NativeModules.BundleUpdaterManager.reload()
                          }),
                          /* @__PURE__ */ jsx(AlertActionButton6, {
                            text: Strings.CANCEL,
                            variant: "secondary"
  ...
  var import_react_native30, import_react_native31, hideActionSheet3, showSimpleActionSheet4, openAlert5, AlertModal6, AlertActionButton6, RDT_EMBED_LINK, useStyles3;
