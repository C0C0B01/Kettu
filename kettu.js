...
(() => {
  ...
  function updateBunnyColor(colorManifest, { update = true }) {
    if (settings.safeMode?.enabled)
      return;
    var resolveType = (type = "dark") => (colorsPref.type ?? type) === "dark" ? "darker" : "light";
    ...
    if (resolveType() == "light" || update) {
      var ref = Object.assign(_colorRef, {
        current: internalDef,
        key: `bn-theme-${++_inc}`,
        lastSetDiscordTheme: !ThemeStore.theme.startsWith("bn-theme-") || !ThemeStore.theme.startsWith("darker") ? ThemeStore.theme : _colorRef.lastSetDiscordTheme
      });
    } else {
      var ref = Object.assign(_colorRef, {
        current: internalDef,
  ...
  var init_default = __esm({
    "src/core/i18n/default.json"() {
      default_default = {
        ...
        AUTO_DEBUGGER: "Automatically connect to Debugger",
        DEVTOOLS_URL: "DevTools URL",
        AUTO_DEVTOOLS: "Automatically connect to Devtools",
        DELETE: "Delete",
  ...
  function initFetchI18nStrings() {
    var cb = ({ locale }) => {
      ...
      if (!_loadedLocale.has(resolvedLocale)) {
        ...
        fetch(`https://codeberg.org/cocobo1/kettu-i18n/src/branch/main/base/${resolvedLocale}.json`).then((r) => r.json()).then((strings) => _loadedStrings[resolvedLocale] = strings).then(() => resolvedLocale === _lastSetLocale && (_currentLocale = resolvedLocale)).catch((e) => console.error(`An error occured while fetching strings for ${resolvedLocale}: ${e}`));
      } else {
  ...
  var import_react_native6, import_react_native7, socket, versionHash;
...
Type: ${asset.type}`,
  ...
  var import_react_native32, import_react_native33, hideActionSheet4, showSimpleActionSheet5, openAlert5, AlertModal6, AlertActionButton6, RDT_EMBED_LINK, useStyles4;
  var init_Developer = __esm({
    "src/core/ui/settings/pages/Developer/index.tsx"() {
      ...
      RDT_EMBED_LINK = "https://codeberg.org/raincord/Devtools/raw/branch/main/reactDevtools.js";
